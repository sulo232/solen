...
3. **Phase 1 and Phase 3 are partially done but UNSTABLE.** Before starting Phase 2, review your code on `feature/customer-frontend`, fix whatever broke the site (likely Next.js layout/page conflicts with the `index.html` iframe, or build errors), and test it locally.
4. Once stable, proceed to Phase 2 (Homepage).
