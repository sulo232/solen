...
export default function MobileViewToggle({ view, onToggle }: MobileViewToggleProps) {
  ...
  return (
    <button
      ...
      className="fixed bottom-24 right-4 z-40 md:hidden bg-s-coral text-white p-4 rounded-pill shadow-elevation-2 hover:shadow-warm-md transition-[transform,box-shadow]"
