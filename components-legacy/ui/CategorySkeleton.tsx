  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-4" aria-hidden="true">
      ...
      <div className="flex items-end justify-between mb-4">
        <div className="h-8 w-40 bg-s-ink/[0.07] rounded-[8px] animate-pulse" />
      ...
      <div className="flex gap-4 overflow-hidden">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="flex-shrink-0 w-[280px] md:w-[320px]">
            ...
            <div className="w-full aspect-[20/19] md:aspect-square bg-s-ink/[0.07] animate-pulse rounded-[12px] mb-3" />
            {/* Name line */}
