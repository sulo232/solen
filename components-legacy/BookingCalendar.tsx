...
import SolenDatePicker from "@/components-legacy/ui/date-picker";
...
import StaffPicker from "@/components-legacy/booking/StaffPicker";
import { Elements, PaymentElement, useStripe, useElements } from "@stripe/react-stripe-js";
import { loadStripe } from "@stripe/stripe-js";
import GuestBookingForm, { type GuestInfo } from "@/components-legacy/booking/GuestBookingForm";
import PackageRedeemBanner from "@/components-legacy/booking/PackageRedeemBanner";
import NailBookingSteps, { type NailOptions } from "@/components-legacy/nail/NailBookingSteps";
import BookingSuccess from "@/components-legacy/BookingSuccess";
            ...
            {waitlistDone ? (
              ...
              <>
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-btn active:scale-[0.97] bg-s-coral text-white text-sm font-medium hover:brightness-[1.06] transition-[transform,filter] duration-150 disabled:opacity-50"
                >
