    ...
    <div className="grid grid-cols-3 gap-2">
      {posts.map((post) => (
        <div key={post.id} className="relative rounded-[16px] overflow-hidden bg-s-ink/5 aspect-square group">
          ...
          <div className="absolute inset-0 bg-s-ink/0 group-hover:bg-s-ink/30 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
