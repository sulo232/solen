...
export default function HomePage({ initialData }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen hero-cinematic relative overflow-x-hidden">
      ...
      {/* ΓöÇΓöÇ Category Anchor Strip (GAP-3) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      >
        {/* Entdecken ΓÇö trending salons across all categories */}
