...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-s-bg-base dark:bg-s-dm-bg flex flex-col items-center justify-center px-4">
      ...
      <h1 className="font-heading text-6xl font-bold text-dark dark:text-s-dm-text mb-2">404</h1>
      <p className="text-lg text-dark/60 dark:text-s-dm-text/60 font-body mb-8 text-center max-w-md">
      ...
      <div className="flex gap-3">
        ...
        <Link
          href="/coiffeur"
          className="px-6 py-3 border border-s-ink/10 text-dark/70 rounded-button font-medium text-sm hover:bg-s-bg-surface transition-colors"
        >
          Salons entdecken
        </Link>
      </div>
