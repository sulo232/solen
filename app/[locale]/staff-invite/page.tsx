      ...
      >
        {success ? (
          <div className="text-center">
            ...
            <a href={`/${locale}/dashboard`} className="inline-block px-6 py-2.5 rounded-button bg-s-coral text-white text-sm font-medium hover:bg-s-coral/90 transition-colors">
              {l.goToDashboard}
            </a>
          </div>
        ) : error ? (
