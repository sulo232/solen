    ...
    <div className="min-h-screen bg-white dark:bg-s-dm-bg">
      ...
      <div className="bg-gradient-to-b from-s-coral/5 to-white dark:from-s-coral/10 dark:to-dm-bg pt-28 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h1 className="font-heading font-bold text-3xl sm:text-4xl text-s-ink dark:text-s-dm-text mb-4">
            Werde Solen-Partner
          </h1>
          <p className="text-lg text-s-ink/60 dark:text-s-dm-text/60 max-w-2xl mx-auto mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {BENEFITS.map((b, i) => (
            <div key={i} className="text-center p-6">
              ...
              <h3 className="font-heading font-semibold text-lg text-s-ink dark:text-s-dm-text mb-2">{b.title}</h3>
              <p className="text-sm text-s-ink/60 dark:text-s-dm-text/60 leading-relaxed">{b.description}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-s-bg-surface dark:bg-s-dm-surface py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="font-heading font-bold text-2xl text-s-ink dark:text-s-dm-text mb-3">
            Bereit loszulegen?
          </h2>
          <p className="text-s-ink/50 dark:text-s-dm-text/50 mb-6">
