    ...
    return (
      <div className="min-h-screen bg-s-bg-surface flex flex-col items-center justify-center gap-3 text-center px-4">
        ...
        <Link href={`/${locale}/coiffeur`}
          className="mt-2 px-6 py-3.5 rounded-btn bg-s-coral text-white text-xs font-heading font-bold uppercase tracking-[.04em] active:scale-[0.97] transition-[transform,filter] duration-150 shadow-elevation-2">
          Salons entdecken
        </Link>
      </div>
    );
