    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-s-bg-base dark:bg-s-dm-bg px-4">
        <div className="text-center">
          ...
          <h1 className="font-heading font-bold text-xl text-s-ink dark:text-s-dm-text mb-2">Danke für dein Trinkgeld!</h1>
          <p className="text-sm text-s-ink/50 dark:text-s-dm-text/50">CHF {(tipAmount / 100).toFixed(2)} gesendet</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-s-bg-base dark:bg-s-dm-bg flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-s-dm-surface rounded-card shadow-card p-5">
          <p className="text-sm font-medium text-s-ink dark:text-s-dm-text mb-3">Trinkgeld geben</p>
          ...
          <button onClick={handlePay} disabled={paying || tipAmount < 100}
            ...
            CHF {(tipAmount / 100).toFixed(2)} Trinkgeld senden
          </button>
        </div>
      </div>
    </div>
