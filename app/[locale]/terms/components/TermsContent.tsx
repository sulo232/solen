    ...
    <div className="prose prose-s-ink max-w-none w-full space-y-12">
      <Section id="section-1" titleDe="1. Geltungsbereich und Vertragsparteien" titleEn="1. Scope and Contracting Parties">
        <Article titleDe="1.1 Betreiberin der Plattform" titleEn="1.1 Platform Operator">
          ...
          <ParEn>solen.ch is operated as a sole proprietorship (Einzelunternehmen) based in Basel-Stadt, Switzerland (hereinafter "solen.ch", "we", or "us").</ParEn>
        ...
        <Article titleDe="1.4 Annahme der AGB" titleEn="1.4 Acceptance of Terms">
          <ParDe>Durch die Erstellung eines Kontos oder die Nutzung von solen.ch erklären Sie sich mit diesen AGB einverstanden. Wenn Sie mit den AGB nicht einverstanden sind, dürfen Sie die Plattform nicht nutzen.</ParDe>
          <ParEn>By creating an account or using solen.ch, you agree to these Terms of Service. If you do not agree, you may not use the platform.</ParEn>
        </Article>
      </Section>

      <Section id="section-2" titleDe="2. Konten und Zugang" titleEn="2. Accounts and Access">
        <Article titleDe="2.1 Mindestalter" titleEn="2.1 Minimum Age">
          <ParDe>Sie müssen mindestens 16 Jahre alt sein, um ein Kundenkonto auf solen.ch zu erstellen.</ParDe>
          <ParEn>You must be at least 16 years old to create a customer account on solen.ch.</ParEn>
        </Article>
        ...
        <Article titleDe="2.5 Kontoinformationen" titleEn="2.5 Account Information">
          <ParDe>Sie sind verpflichtet, bei der Registrierung korrekte und vollständige Angaben zu machen und diese aktuell zu halten. Sie sind für die Sicherheit Ihrer Zugangsdaten allein verantwortlich.</ParDe>
          <ParEn>You are required to provide accurate and complete information during registration and to keep it up to date. You are solely responsible for the security of your login credentials.</ParEn>
        </Article>
      </Section>
      ...
      <Section id="section-3" titleDe="3. Buchungen" titleEn="3. Bookings">
        ...
        <Article titleDe="3.2 Änderungen durch Kunden" titleEn="3.2 Modifications by Customers">
          <ParDe>Kunden können eine Buchung bis <strong>24 Stunden vor dem Termin</strong> kostenlos ändern (z.B. Zeitpunkt oder Dienstleistung). Änderungen innerhalb von 24 Stunden vor dem Termin sind nicht möglich.</ParDe>
      ...
      <Section id="section-4" titleDe="4. Stornierung und Nichterscheinen" titleEn="4. Cancellation and No-Show">
        <Article titleDe="4.1 Kostenlose Stornierung" titleEn="4.1 Free Cancellation">
          <ParDe>Kunden können eine Buchung bis <strong>24 Stunden vor dem Termin</strong> kostenlos stornieren und erhalten eine vollständige Rückerstattung.</ParDe>
          <ParEn>Customers may cancel a booking free of charge up to <strong>24 hours before the appointment</strong> and receive a full refund.</ParEn>
        </Article>

        <Article titleDe="4.2 Verspätete Stornierung" titleEn="4.2 Late Cancellation">
          <ParDe>Wird eine Buchung weniger als 24 Stunden vor dem Termin storniert, wird eine Gebühr in Höhe von <strong>50 % des Buchungswertes</strong> erhoben. Der verbleibende Betrag wird dem Kunden erstattet. Diese Gebühr wird plattformweit von solen.ch festgelegt.</ParDe>
        ...
        <Article titleDe="4.5 Anzahlung" titleEn="4.5 Deposits">
          <ParDe>Ein Anzahlungssystem für hochpreisige Buchungen ist derzeit nicht verfügbar, aber für eine spätere Einführung geplant.</ParDe>
          <ParEn>A deposit system for high-value bookings is currently not available but is planned for future implementation.</ParEn>
        </Article>
      </Section>

      <Section id="section-5" titleDe="5. Zahlungen, Gebühren und Auszahlungen" titleEn="5. Payments, Fees, and Payouts">
        ...
        <Article titleDe="5.2 Zahlungsabwicklung" titleEn="5.2 Payment Processing">
          <ParDe>Die Zahlungsabwicklung erfolgt über Stripe. Mit der Nutzung von solen.ch akzeptieren Sie die geltenden Nutzungsbedingungen von Stripe (<a href="https://stripe.com/legal" target="_blank" rel="noopener noreferrer" className="text-s-coral underline hover:no-underline">https://stripe.com/legal</a>).</ParDe>
          <ParEn>Payment processing is handled by Stripe. By using solen.ch, you accept the applicable Stripe terms of service (<a href="https://stripe.com/legal" target="_blank" rel="noopener noreferrer" className="text-s-coral underline hover:no-underline">https://stripe.com/legal</a>).</ParEn>
        </Article>
      ...
      <Section id="section-6" titleDe="6. Pflichten der Salonpartner" titleEn="6. Salon Partner Obligations">
        ...
        <Article titleDe="6.5 Inhaltsrichtlinien" titleEn="6.5 Content Guidelines">
          ...
          <ul className="list-disc pl-5 my-2 space-y-1 text-sm md:text-base text-s-ink opacity-90">
            ...
            <li>Keine Nacktheit oder anstössigen Inhalte / No nudity or offensive content</li>
            <li>Keine diskriminierenden Inhalte / No discriminatory content</li>
            <li>Preise müssen korrekt und in CHF angegeben sein / Prices must be accurate and in CHF</li>
          </ul>
          <ParDe>solen.ch behält sich das Recht vor, Inhalte, die gegen diese Richtlinien verstossen, ohne Vorankündigung zu entfernen.</ParDe>
          <ParEn>solen.ch reserves the right to remove content that violates these guidelines without prior notice.</ParEn>
        </Article>
        ...
        <Article titleDe="6.6 Massnahmen bei wiederholten Beschwerden" titleEn="6.6 Measures for Repeated Complaints">
          ...
          <ParDe>solen.ch hat das endgültige Ermessen bei der Anwendung dieser Massnahmen.</ParDe>
          <ParEn>solen.ch retains final discretion in applying these measures.</ParEn>
        </Article>
      </Section>

      <Section id="section-7" titleDe="7. Pflichten der Kunden" titleEn="7. Customer Obligations">
        <Article titleDe="7.1 Korrekte Angaben" titleEn="7.1 Accurate Information">
          <ParDe>Kunden sind verpflichtet, bei der Buchung korrekte Kontaktdaten anzugeben und pünktlich zu den vereinbarten Terminen zu erscheinen.</ParDe>
          <ParEn>Customers are required to provide accurate contact information when booking and to arrive on time for scheduled appointments.</ParEn>
        </Article>

        <Article titleDe="7.2 Bewertungen" titleEn="7.2 Reviews">
          <ParDe>Kunden, die eine Dienstleistung über solen.ch in Anspruch genommen haben (bestätigter abgeschlossener Termin), können eine öffentliche Bewertung hinterlassen. Bewertungen sind für alle Nutzer sichtbar.</ParDe>
          <ParEn>Customers who have received a service through solen.ch (confirmed completed appointment) may leave a public review. Reviews are visible to all users.</ParEn>
          <div className="mt-4" />
      ...
      <Section id="section-8" titleDe="8. Geistiges Eigentum" titleEn="8. Intellectual Property">
        <Article titleDe="8.1 Plattforminhalte" titleEn="8.1 Platform Content">
          <ParDe>Sämtliche Inhalte der Plattform solen.ch (einschliesslich Design, Logo, Texte, Software und Grafiken) sind Eigentum von solen.ch oder deren Lizenzgebern und urheberrechtlich geschützt.</ParDe>
        ...
        <Article titleDe="8.4 Nutzung von Bewertungen" titleEn="8.4 Use of Reviews">
          <ParDe>Bewertungen, die auf solen.ch veröffentlicht werden, dürfen von solen.ch in eigenen Marketingmaterialien zitiert und verwendet werden.</ParDe>
          <ParEn>Reviews published on solen.ch may be quoted and used by solen.ch in its own marketing materials.</ParEn>
        </Article>
      </Section>
      ...
      <Section id="section-9" titleDe="9. Datenschutz" titleEn="9. Privacy">
        <Article titleDe="9.1 Datenschutzerklärung" titleEn="9.1 Privacy Policy">
          <ParDe>solen.ch verfügt über eine separate Datenschutzerklärung, die unter <a href="/privacy" className="text-s-coral underline hover:no-underline">solen.ch/privacy</a> abrufbar ist. Die Datenschutzerklärung ist Bestandteil dieser AGB.</ParDe>
          <ParEn>solen.ch maintains a separate Privacy Policy available at <a href="/privacy" className="text-s-coral underline hover:no-underline">solen.ch/privacy</a>. The Privacy Policy forms an integral part of these Terms.</ParEn>
        </Article>
        ...
        <Article titleDe="9.2 Datenverarbeiter" titleEn="9.2 Data Processors">
          ...
          <ParDe>Es werden keine Nutzerdaten an Dritte verkauft.</ParDe>
          <ParEn>No user data is sold to third parties.</ParEn>
        </Article>
        ...
        <Article titleDe="9.3 Cookies und Tracking" titleEn="9.3 Cookies and Tracking">
          ...
          <ParDe>Details finden Sie in unserer Datenschutzerklärung und Cookie-Richtlinie.</ParDe>
          <ParEn>Details can be found in our Privacy Policy and Cookie Policy.</ParEn>
        </Article>
        ...
        <Article titleDe="9.5 Rechte der Nutzer" titleEn="9.5 User Rights">
          <ParDe>Nutzer haben das Recht, den Export ihrer personenbezogenen Daten zu verlangen. Nutzer können auch die Löschung ihrer personenbezogenen Daten verlangen, wobei Finanz- und Buchungsdaten aufgrund der gesetzlichen Aufbewahrungspflicht in anonymisierter Form aufbewahrt werden.</ParDe>
          <ParEn>Users have the right to request the export of their personal data. Users may also request the deletion of their personal data, subject to the legal retention requirement for financial and booking data, which will be retained in anonymized form.</ParEn>
        </Article>
      </Section>
      ...
      <Section id="section-10" titleDe="10. Haftung und Haftungsausschluss" titleEn="10. Liability and Disclaimers">
        ...
        <Article titleDe="10.2 Haftungsausschluss für Plattformverfügbarkeit" titleEn="10.2 Disclaimer of Platform Availability">
          <ParDe>solen.ch bemüht sich um eine hohe Verfügbarkeit der Plattform, kann jedoch keinen unterbrechungsfreien Betrieb garantieren. solen.ch haftet nicht für Verluste, die durch Plattformausfälle, technische Störungen, verlorene Buchungen oder Datenverluste entstehen. Höhere Gewalt (einschliesslich, aber nicht beschränkt auf Naturkatastrophen, Cyberangriffe, behördliche Anordnungen und Ausfälle von Drittanbieterdiensten) entbindet solen.ch von jeglicher Leistungspflicht.</ParDe>
      ...
      <Section id="section-11" titleDe="11. Änderungen der AGB" titleEn="11. Amendments to Terms">
        <Article titleDe="11.1 Änderungsrecht" titleEn="11.1 Right to Amend">
          <ParDe>solen.ch behält sich das Recht vor, diese AGB jederzeit zu ändern.</ParDe>
          <ParEn>solen.ch reserves the right to amend these Terms of Service at any time.</ParEn>
        </Article>
        ...
        <Article titleDe="11.3 Benachrichtigung" titleEn="11.3 Notification">
          ...
          <ParDe>Die fortgesetzte Nutzung der Plattform nach Inkrafttreten der Änderungen gilt als Annahme der geänderten AGB.</ParDe>
          <ParEn>Continued use of the platform after changes take effect constitutes acceptance of the amended Terms.</ParEn>
        </Article>
      </Section>

      <Section id="section-12" titleDe="12. Kontosperrung und Kündigung" titleEn="12. Account Suspension and Termination">
        <Article titleDe="12.1 Sperrungsgründe" titleEn="12.1 Grounds for Suspension">
          ...
          <ul className="list-disc pl-5 my-2 space-y-1 text-sm md:text-base text-s-ink opacity-90">
            ...
            <li>Verstoss gegen diese AGB / Violation of these Terms</li>
          </ul>
        </Article>
        ...
        <Article titleDe="12.2 Sofortige Kündigung" titleEn="12.2 Immediate Termination">
          ...
          <ul className="list-disc pl-5 my-2 space-y-1 text-sm md:text-base text-s-ink opacity-90">
            ...
            <li>Identitätsdiebstahl oder Nachahmung / Identity theft or impersonation</li>
            <li>Geldwäscherei / Money laundering</li>
            <li>Wiederholte schwere Verstösse gegen die AGB nach vorheriger Verwarnung / Repeated serious violations after prior warning</li>
          </ul>
        </Article>
      ...
      <Section id="section-13" titleDe="13. Streitbeilegung und anwendbares Recht" titleEn="13. Dispute Resolution and Governing Law">
        ...
        <Article titleDe="13.3 Anwendbares Recht und Gerichtsstand" titleEn="13.3 Governing Law and Jurisdiction">
          <ParDe>Diese AGB unterstehen dem schweizerischen Recht. Ausschliesslicher Gerichtsstand ist Basel-Stadt, Schweiz.</ParDe>
          <ParEn>These Terms are governed by Swiss law. The exclusive place of jurisdiction is Basel-Stadt, Switzerland.</ParEn>
        </Article>
      </Section>

      <Section id="section-14" titleDe="14. Treueprogramm" titleEn="14. Loyalty Program">
        <Article titleDe="" titleEn="">
          <ParDe>Ein Treueprogramm für Kunden ist derzeit nicht verfügbar, aber für eine spätere Einführung geplant.</ParDe>
          <ParEn>A loyalty program for Customers is currently not available but is planned for future implementation.</ParEn>
        </Article>
      </Section>

      <Section id="section-15" titleDe="15. Schlussbestimmungen" titleEn="15. Final Provisions">
        <Article titleDe="15.1 Salvatorische Klausel" titleEn="15.1 Severability">
          <ParDe>Sollte eine Bestimmung dieser AGB unwirksam oder undurchsetzbar sein, bleiben die übrigen Bestimmungen davon unberührt. Die unwirksame Bestimmung wird durch eine wirksame ersetzt, die dem wirtschaftlichen Zweck der unwirksamen Bestimmung am nächsten kommt.</ParDe>
          <ParEn>If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions shall remain unaffected. The invalid provision shall be replaced by a valid one that most closely reflects the economic purpose of the invalid provision.</ParEn>
        </Article>

        <Article titleDe="15.2 Vollständigkeit" titleEn="15.2 Entirety">
          <ParDe>Diese AGB sowie die Datenschutzerklärung stellen die vollständige Vereinbarung zwischen dem Nutzer und solen.ch dar und ersetzen alle früheren Vereinbarungen oder Absprachen.</ParDe>
          <ParEn>These Terms, together with the Privacy Policy, constitute the entire agreement between the user and solen.ch, superseding all prior agreements or understandings.</ParEn>
        </Article>
        ...
        <Article titleDe="15.3 Impressum" titleEn="15.3 Legal Notice">
          <div className="bg-s-ink/5 p-4 rounded-xl text-sm md:text-base text-s-ink">
            ...
            <p>E-Mail / Email: <a href="mailto:support@solen.ch" className="text-s-coral hover:underline">support@solen.ch</a></p>
          </div>
        </Article>
      </Section>
    </div>
