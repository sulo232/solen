    ...
    <div className="min-h-screen bg-white dark:bg-s-dm-bg pt-8 pb-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="prose prose-sm max-w-none text-dark/70 dark:text-s-dm-text/70 space-y-6">
          <section>
            <h2 className="font-heading font-semibold text-lg text-dark dark:text-s-dm-text">1. Verantwortliche Stelle</h2>
            <p>[PLATZHALTER — Bitte echten Text einsetzen]</p>
            <p>Solen.ch, [Adresse], Basel, Schweiz</p>
          </section>

          <section>
            <h2 className="font-heading font-semibold text-lg text-dark dark:text-s-dm-text">2. Erhobene Daten</h2>
            <p>[PLATZHALTER — Bitte echten Text einsetzen]</p>
          ...
          <section>
            <h2 className="font-heading font-semibold text-lg text-dark dark:text-s-dm-text">3. Zweck der Datenverarbeitung</h2>
            <p>[PLATZHALTER — Bitte echten Text einsetzen]</p>
          </section>

          <section>
            <h2 className="font-heading font-semibold text-lg text-dark dark:text-s-dm-text">4. Cookies</h2>
            <p>[PLATZHALTER — Bitte echten Text einsetzen]</p>
          ...
          <section>
            <h2 className="font-heading font-semibold text-lg text-dark dark:text-s-dm-text">5. Drittanbieter</h2>
          ...
          <section>
            <h2 className="font-heading font-semibold text-lg text-dark dark:text-s-dm-text">6. Ihre Rechte</h2>
            <p>[PLATZHALTER — Bitte echten Text einsetzen]</p>
          ...
          <section>
            <h2 className="font-heading font-semibold text-lg text-dark dark:text-s-dm-text">7. Kontakt</h2>
