 ...
 * real entries.
 */
const DEMO_SALONS: Pick<
  SalonCardProps,
  "slug" | "name" | "rating" | "category" | "variant" | "availabilityRow"
>[] = [
  { slug: "atelier-coiffure", name: "Atelier Coiffure", rating: 4.9, category: "coiffeur", variant: "availability", availabilityRow: "14:30, 15:00, 16:30" },
  { slug: "studio-nord", name: "Studio Nord", rating: 4.7, category: "barbershop", variant: "availability", availabilityRow: "In 25 Min frei" },
  { slug: "nail-loft", name: "Nail Loft", rating: 4.8, category: "nails", variant: "availability", availabilityRow: "Heute 17:00, 18:30" },
  { slug: "rheinspa", name: "Rhein Spa", rating: 4.95, category: "spa", variant: "availability", availabilityRow: "Nächster Termin Mo. 09:00" },
];
