...
const STATUS_COLORS: Record<string, string> = {
  ...
  customer_approved: "bg-teal/10 text-teal",
                ...
                {d.status === "disputed" && (
                  <div className="flex items-center gap-2 mt-4 pt-3 border-t border-gray-100">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-2 rounded-button bg-teal text-white text-xs font-medium hover:bg-teal/90 transition-colors disabled:opacity-50"
                    >
