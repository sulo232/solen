      ...
      {loading ? (
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
            <StatCard label="Salons" value={stats?.total_salons ?? 0} icon={Store} bg="bg-teal/5" color="text-teal" />
            ...
            <StatCard label="Umsatz (30T)" value={stats?.total_revenue_30d ?? 0} prefix="CHF " icon={DollarSign} bg="bg-teal/5" color="text-teal" />
          ...
          >
            <BarChart3 size={36} className="mx-auto mb-3 text-teal opacity-40" />
