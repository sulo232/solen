              ...
              {bookings.map((b) => (
                <div key={b.id} className="bg-white dark:bg-s-dm-surface rounded-card border border-s-ink/5 dark:border-white/5 p-3 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <span className={`text-[10px] font-medium px-1.5 py-0.5 rounded ${b.status === "confirmed" ? "bg-green-100 text-green-700" : b.status === "cancelled" ? "bg-red-100 text-red-700" : "bg-s-ink/5 text-s-ink/50"}`}>
                      {b.status}
                    </span>
