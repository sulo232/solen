        ...
        <div className="max-w-5xl mx-auto px-4 py-6">
          ...
          {tech.salon_slug && (
            <Link
              ...
              className="mt-4 inline-flex items-center gap-2 px-6 py-2.5 rounded-button bg-s-coral text-white font-medium text-sm hover:bg-s-coral-hover transition-colors"
            >
              <Sparkles size={16} />
