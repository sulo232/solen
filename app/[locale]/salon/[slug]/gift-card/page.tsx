      ...
      <div className="min-h-screen flex items-center justify-center bg-s-bg-base dark:bg-s-dm-bg px-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm text-s-ink/50 dark:text-s-dm-text/50 mb-4">
            CHF {(amount / 100).toFixed(2)} für {recipientName}
          </p>
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white dark:bg-s-dm-surface rounded-card shadow-card p-5 space-y-4">
          ...
          <div className="rounded-card border border-s-coral/20 bg-s-coral/5 p-4 text-center">
            ...
            <p className="font-heading font-bold text-lg text-s-coral data-text">CHF {(amount / 100).toFixed(2)}</p>
          ...
          <button onClick={handlePurchase} disabled={paying || amount < 500 || !recipientName.trim() || !recipientEmail.trim()}
            ...
            Geschenkkarte kaufen · CHF {(amount / 100).toFixed(2)}
          </button>
        </div>
      </div>
    </div>
