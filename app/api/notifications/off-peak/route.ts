...
export async function POST(req: NextRequest) {
  ...
  const { data: validated, error: validationError } = validateBody(offPeakNotificationSchema, body);
          ...
          html: `
            <div style="font-family: 'DM Sans', sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
              ...
              <p style="color: #999; font-size: 12px; margin-top: 24px;">
                ...
                <a href="https://www.solen.ch/de/profile" style="color: #C05038;">Benachrichtigungen verwalten</a>
              </p>
