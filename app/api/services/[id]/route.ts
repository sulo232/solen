...
export async function PATCH(
  ...
  const allowed = [
    "name_de", "name_en", "category", "duration_minutes", "price",
    "description_de", "buffer_minutes", "processing_minutes", "finishing_minutes",
    "suitable_for", "suitable_gender", "is_active", "photos",
  ];
