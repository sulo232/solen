            ...
            {services.map((s) => (
              ...
              >
                ...
                <Link
                  ...
                  className="px-4 py-2 rounded-btn active:scale-[0.98] bg-s-coral text-white text-sm font-medium hover:brightness-[1.06] transition-[transform,filter] shadow-warm-sm"
                >
                  Buchen
                </Link>
              </div>
