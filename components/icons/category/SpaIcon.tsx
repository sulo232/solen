...
export function SpaIcon({ animate = false, ...props }: React.SVGProps<SVGSVGElement> & { animate?: boolean }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none" {...props}>
      ...
      <ellipse cx="20" cy="8.5" rx="4.5" ry="10" fill="#1B4D1B" transform="rotate(60 20 20)" />
      <ellipse cx="20" cy="8.5" rx="4.5" ry="10" fill="#1B4D1B" transform="rotate(180 20 20)" />
      <ellipse cx="20" cy="8.5" rx="4.5" ry="10" fill="#1B4D1B" transform="rotate(300 20 20)" />
