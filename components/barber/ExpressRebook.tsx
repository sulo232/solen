        ...
        <div className="flex-1 min-w-0">
          ...
          {step === "idle" && (
            <button
              ...
              className="mt-3 w-full flex items-center justify-center gap-2 rounded-pill active:scale-[0.97] bg-s-coral text-white font-heading font-bold uppercase tracking-[.04em] py-2.5 text-xs hover:brightness-[1.06] transition-[transform,filter] duration-150 shadow-coral-glow"
            >
              <RefreshCw size={16} />
              {t("express.rebook")}
            </button>
          ...
          {step === "confirm" && suggested && (
            <div className="mt-3 space-y-2">
              ...
              <button
                ...
                className="w-full rounded-pill active:scale-[0.97] bg-s-coral text-white font-heading font-bold uppercase tracking-[.04em] py-2.5 text-xs hover:brightness-[1.06] transition-[transform,filter] duration-150 shadow-coral-glow"
              >
                {t("express.confirm")}
              </button>
            </div>
