    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute right-0 mt-2 w-80 bg-white/90 backdrop-blur-lg dark:bg-s-dm-surface/90 rounded-card shadow-warm-lg border border-s-ink/5 dark:border-white/10 z-50 overflow-hidden flex flex-col max-h-[80vh]">
