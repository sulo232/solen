        ...
        {disputes.map((d) => (
          <div key={d.id} className="rounded-[12px] border border-s-ink/5 dark:border-white/5 bg-white dark:bg-s-dm-surface p-5">
            ...
            <div className="mb-3 p-3 bg-s-bg-surface rounded-btn">
              <p className="text-xs text-s-ink/40 font-body mb-1">{t("description")}</p>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="flex items-center gap-1.5 ml-auto">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-btn active:scale-[0.98] bg-s-coral text-white text-xs font-medium hover:brightness-[1.06] transition-all"
                    >
                      {t("refund")}
                    </button>
                  </div>
