...
export default function ServiceTile({ category, minPrice, isFavorite = false, locale = "de" }: ServiceTileProps) {
  ...
  return (
    <Link
      ...
      className="relative flex-shrink-0 flex flex-col items-center justify-center gap-2 w-28 h-28 rounded-[12px] bg-white dark:bg-s-dm-surface shadow-warm-sm hover:shadow-v5-card-hover hover:-translate-y-[5px] transition-[transform,box-shadow] duration-[400ms] ease-[cubic-bezier(0.23,1,0.32,1)] p-3"
    >
      {isFavorite && (
