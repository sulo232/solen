...
function StatCounter({ item, isVisible }: { item: StatItem; isVisible: boolean }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span
        className="text-xs text-s-ink/60 dark:text-s-dm-text/60 font-body font-medium"
...
export default function SocialProofStrip() {
  ...
  return (
    <div ref={ref} className="bg-s-coral/5 dark:bg-s-coral/10 border-y border-s-coral/10 dark:border-s-coral/15">
