...
export default function SolenExclusiveBadge({
  ...
  return (
    ...
    >
      <span className="inline-flex items-center gap-1 text-[10px] font-medium bg-gradient-to-r from-s-coral-500/20 to-s-coral-400/10 text-s-coral-700 px-1.5 py-0.5 rounded-pill border border-s-coral-200/50 cursor-help whitespace-nowrap">
        <Sparkles size={10} />
        Nur bei Solen
      </span>
      {showTooltip && (
