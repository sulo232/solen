  ...
  return (
    ...
    >
      ...
      <div className="relative mb-5">
        ...
        <div className="relative flex items-center justify-center w-16 h-16 rounded-[20px] bg-s-coral/10">
      ...
      {message && (
        <p className="font-body italic text-s-ink/50 text-sm max-w-xs leading-relaxed">{message}</p>
      )}
