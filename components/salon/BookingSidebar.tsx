...
export default function BookingSidebar({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onBook}
        className="w-full h-12 rounded-[12px] bg-[#E8624A] text-white font-heading font-bold text-[16px] hover:brightness-95 active:scale-[0.98] transition-all duration-150 mb-4"
