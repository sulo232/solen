  ...
  return (
    <div className="flex flex-col items-center gap-4 py-6">
      ...
      <div className="relative">
        ...
        <button
          className="absolute bottom-0 right-0 w-7 h-7 rounded-full bg-s-coral text-white flex items-center justify-center shadow-warm-sm hover:brightness-[1.06] active:scale-[0.98] transition-all"
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          className="w-9 h-9 rounded-full bg-s-ink/[0.05] dark:bg-white/[0.08] text-s-ink dark:text-s-dm-text flex items-center justify-center hover:bg-s-ink/[0.09] dark:hover:bg-white/[0.12] active:scale-[0.98] transition-all"
        ...
        <button
          className="w-9 h-9 rounded-full bg-s-ink/[0.05] dark:bg-white/[0.08] text-s-coral flex items-center justify-center hover:bg-s-ink/[0.09] dark:hover:bg-white/[0.12] active:scale-[0.98] transition-all"
