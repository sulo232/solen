...
export default function QuartierTile({
  ...
  return (
    <Link
      ...
      className="relative flex-shrink-0 w-40 h-24 rounded-[12px] bg-white shadow-warm-sm hover:shadow-warm-lg hover:-translate-y-[5px] transition-[transform,box-shadow] duration-250 flex flex-col justify-between p-3 overflow-hidden group"
    >
      {/* Icon background */}
      {(() => {
