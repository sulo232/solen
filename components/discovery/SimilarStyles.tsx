        ...
        {loading ? (
          ...
          items.map((item) => (
            <div
              ...
              className="w-32 shrink-0 snap-start rounded-card overflow-hidden bg-white dark:bg-s-dm-surface border border-s-ink/5 dark:border-white/5 cursor-pointer hover:shadow-card-hover hover:-translate-y-[5px] transition-all duration-250"
            >
