  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-9 pr-8 py-2.5 rounded-pill bg-s-bg-sunken dark:bg-s-dm-surface border border-s-ink/10 dark:border-white/5 text-sm text-s-ink dark:text-s-dm-text placeholder:text-s-ink/30"
      />
      {local && (
