          ...
          <>
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-btn border border-s-ink/[0.08] text-sm font-heading font-semibold text-s-ink hover:border-s-ink/40 hover:bg-white active:scale-[0.97] transition-[transform,filter] duration-150 mb-3"
              >
