          ...
          <>
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-btn border border-s-ink/[0.08] dark:border-white/[0.08] text-sm font-heading font-semibold text-s-ink dark:text-s-dm-text hover:border-s-ink/40 hover:bg-s-bg-base active:scale-[0.97] transition-[transform,filter] duration-150 mb-3"
              >
              ...
              <Link
                ...
                onClick={() => setLoginSheet(s => ({ ...s, open: false }))}
                className="w-full flex items-center justify-center py-3.5 rounded-btn bg-s-coral text-white text-sm font-heading font-bold active:scale-[0.97] transition-[transform,filter,border-color,background-color] duration-150"
