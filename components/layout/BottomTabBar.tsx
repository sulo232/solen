          ...
          <>
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 w-9 h-9 flex items-center justify-center rounded-full bg-s-bg-surface hover:bg-s-ink/[0.08] transition-colors"
              >
                <X size={15} className="text-s-ink/60" />
              </button>

              <h2 className="font-heading font-bold text-xl text-s-ink mb-1">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-btn border border-s-ink/[0.08] text-sm font-heading font-semibold text-s-ink hover:border-s-ink/40 hover:bg-s-bg-base active:scale-[0.98] transition-[transform,filter] duration-150 mb-3"
              >
