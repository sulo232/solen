        ...
        {loginSheet.open && (
          <>
            ...
            >
              ...
              <p className="text-[14px] font-body text-[s-ink/60] mb-7 leading-snug">
                {contextMessage}
              </p>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-btn border border-s-ink/[0.08] text-[14px] font-heading font-semibold text-s-ink hover:border-[#AAAAAA] hover:bg-[#FAFAFA] active:scale-[0.98] transition-[transform,filter] duration-150 mb-3"
              >
              ...
              <Link
                ...
                onClick={() => setLoginSheet(s => ({ ...s, open: false }))}
                className="w-full flex items-center justify-center py-3.5 rounded-btn bg-s-coral text-white text-[14px] font-heading font-bold active:scale-[0.98] transition-[transform,filter,border-color,background-color] duration-150"
