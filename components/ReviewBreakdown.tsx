...
export default function ReviewBreakdown({
  ...
  const subCategories = [
    { label: "Ergebnis", avg: calcAvg("score_ergebnis") },
    { label: "Atmosphäre", avg: calcAvg("score_atmosphaere") },
    { label: "Preis-Leistung", avg: calcAvg("score_preis_leistung") },
  ].filter(({ avg }) => avg > 0);
