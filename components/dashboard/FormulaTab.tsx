        ...
        <div className="rounded-card border border-s-coral/20 bg-s-coral/5 p-4 mb-4 space-y-3">
          ...
          <div>
            ...
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={2} placeholder="Zusätzliche Hinweise…"
              className="w-full px-2 py-1.5 rounded-button border border-s-ink/10 dark:border-white/10 bg-white dark:bg-s-dm-bg text-sm text-s-ink dark:text-s-dm-text focus:outline-none focus:border-s-coral resize-none" />
          </div>
