      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <select value={photoType} onChange={(e) => setPhotoType(e.target.value as "before" | "after" | "progress")}
            className="px-2 py-1 rounded-button border border-s-ink/10 dark:border-white/10 bg-white dark:bg-s-dm-bg text-xs text-s-ink dark:text-s-dm-text focus:outline-none focus:border-s-coral">
