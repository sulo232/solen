            ...
            >
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  placeholder="—"
                  className="w-16 px-2 py-1 text-sm text-center rounded-input border border-s-ink/10 dark:border-s-dm-text/10 bg-transparent text-s-ink dark:text-s-dm-text"
                />
