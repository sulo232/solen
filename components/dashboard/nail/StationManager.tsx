  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="font-heading font-semibold text-sm text-s-ink dark:text-s-dm-text">Stationen verwalten</h3>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <label className="block">
          <span className="text-xs font-medium text-s-ink/60 dark:text-s-dm-text/60">Anzahl Stationen</span>
          <input
            type="number"
            min={1}
            max={20}
        ...
        <label className="block">
          <span className="text-xs font-medium text-s-ink/60 dark:text-s-dm-text/60">UV-Lampen</span>
          <input
            type="number"
            min={0}
            max={20}
        ...
        <label className="block">
          <span className="text-xs font-medium text-s-ink/60 dark:text-s-dm-text/60">Sterilisations-Puffer (Min.)</span>
          <input
            type="number"
            min={0}
            max={60}
      ...
      <div className="p-3 rounded-card bg-s-bg-surface dark:bg-s-dm-bg">
        <div className="flex items-center justify-between text-xs text-s-ink/60 dark:text-s-dm-text/60 mb-1">
          ...
          <span>0 von {config.total_stations} belegt</span>
        </div>
