...
export default function WalkInModal({ salonId, services, staff, onClose, onCreated }: WalkInModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-s-ink/40 backdrop-blur-sm px-4" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="walkin-modal-title">
      <div className="bg-white dark:bg-s-dm-surface rounded-card shadow-warm-lg w-full max-w-sm p-6" onClick={e => e.stopPropagation()}>
