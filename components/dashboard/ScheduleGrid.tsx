    ...
    <div className="space-y-3">
      ...
      <div className="sticky bottom-0 bg-white border-t border-s-ink/5 p-3 z-10 -mx-3">
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex items-center gap-2 px-4 py-2.5 rounded-pill active:scale-[0.97] bg-s-coral text-white text-[11px] font-heading font-bold uppercase tracking-[.06em] hover:brightness-[1.06] shadow-elevation-2 disabled:opacity-50 transition-[transform,filter] duration-150"
        >
