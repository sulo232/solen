        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {urls.map((url, index) => (
            <div
              ...
              className={`group relative aspect-[4/3] rounded-[12px] overflow-hidden border border-s-ink/10 dark:border-white/10 bg-s-bg-sunken dark:bg-s-dm-surface cursor-grab active:cursor-grabbing ${
                draggedIndex === index
                  ? "opacity-50 scale-95"
