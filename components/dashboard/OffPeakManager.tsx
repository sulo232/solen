      ...
      <div className="border-t border-s-ink/5 pt-4 space-y-3">
        ...
        <div className="flex flex-wrap gap-2 items-end">
          ...
          <button
            onClick={handleAdd}
            disabled={saving}
            className="px-4 py-1.5 rounded-pill active:scale-[0.97] bg-s-coral text-white text-[11px] font-heading font-bold uppercase tracking-[.06em] disabled:opacity-50 flex items-center gap-1.5 shadow-coral-glow transition-[transform,filter] duration-150"
          >
