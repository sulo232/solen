  ...
  return (
    <div className="rounded-[16px] bg-white border border-s-ink/5 p-4">
      ...
      <div className="space-y-3">
        <div>
          <label className="block text-xs font-medium text-s-ink/70 mb-1">{t("name_label")}</label>
          <input
            type="text"
            value={program.name}
        ...
        <div>
          <label className="block text-xs font-medium text-s-ink/70 mb-1">{t("reward_label")}</label>
          <select
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm text-s-ink">{t("active")}</span>
          <button
