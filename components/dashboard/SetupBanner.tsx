...
export default function SetupBanner() {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-card border border-s-coral/20 p-5 mb-6 shadow-sm"
    >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-1 mt-1.5">
            ...
            {incompleteSteps.length > 3 && (
              <span className="px-2 py-0.5 rounded-pill text-[10px] bg-s-bg-sunken text-s-ink/30">
                +{incompleteSteps.length - 3}
              </span>
            )}
          </div>
