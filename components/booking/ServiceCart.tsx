      ...
      <div className="space-y-2 pt-2 border-t border-s-ink/5 dark:border-white/5">
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="flex-1 px-2 py-1.5 rounded-button border border-s-ink/10 dark:border-white/10 bg-s-bg-surface dark:bg-s-dm-bg text-xs text-s-ink dark:text-s-dm-text outline-none focus:border-s-coral"
          />
        </div>
        <div className="flex items-center gap-2">
