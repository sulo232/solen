...
export default function QuartierTile({
  ...
  return (
    <Link
      ...
      className="relative flex-shrink-0 w-40 h-24 rounded-card bg-white dark:bg-s-dm-raised shadow-card hover:shadow-card-hover hover:-translate-y-[5px] transition-all duration-250 flex flex-col justify-between p-3 overflow-hidden group"
    >
      {/* Icon background */}
      {(() => {
