  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full py-4 rounded-button bg-s-coral text-white text-base font-bold disabled:opacity-50 flex items-center justify-center gap-2 hover:bg-s-coral/90 transition-colors shadow-warm-sm"
      >
