        ...
        <>
          ...
          {showAdd ? (
            <div className="bg-white dark:bg-s-dm-surface rounded-card border border-s-coral/20 p-5 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-button border border-s-ink/10 dark:border-white/10 bg-white dark:bg-s-dm-raised text-sm text-s-ink dark:text-s-dm-text focus:outline-none focus:border-s-coral"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-button bg-s-coral text-white text-sm font-medium disabled:opacity-50 flex items-center justify-center gap-2 shadow-warm-sm"
              >
            ...
            <button
              ...
              className="w-full py-3 rounded-button border-2 border-dashed border-s-ink/10 dark:border-white/10 text-sm text-s-ink/40 dark:text-s-dm-text/40 hover:border-s-coral/40 hover:text-s-coral transition-colors flex items-center justify-center gap-2"
            >
              <Plus size={16} />
              {t("services.add")}
            </button>
