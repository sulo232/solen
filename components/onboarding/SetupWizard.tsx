      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mt-8 pt-6 border-t border-s-ink/5 dark:border-white/5">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={goNext}
              className="flex items-center gap-1.5 px-6 py-2.5 rounded-btn active:scale-[0.98] bg-s-coral text-white text-sm font-medium hover:bg-s-coral/90 transition-all shadow-warm-sm"
            >
